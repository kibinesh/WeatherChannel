...
/******************************************************INSERT YOUR CODE BELOW!!!***********************************************/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=3ea05644d6114880a3b193000180904',
                      data: message             
                })
                .done(function(json){
                     ...
                     $('#Day11Low').html("<center>" + json.forecast.forecastday[10].day.mintemp_f + "</center>");
                     $('#Day11High').html("<center>" + json.forecast.forecastday[10].day.maxtemp_f + "</center>");
